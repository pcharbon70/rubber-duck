...
config :ex_cldr, default_backend: RubberDuck.Cldr
config :ash_oban, pro?: false

config :rubber_duck, Oban,
...
config :rubber_duck,
  ...
  ash_domains: [RubberDuck.Accounts]
...
config :rubber_duck, RubberDuckWeb.Endpoint,
  ...
  live_view: [signing_salt: "lds5JrhN"]
...
config :rubber_duck, RubberDuck.Mailer, adapter: Swoosh.Adapters.Local
