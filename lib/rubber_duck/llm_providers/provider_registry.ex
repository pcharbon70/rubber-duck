defmodule RubberDuck.LlmProviders.ProviderRegistry do
  ...
  def handle_call({:register_provider, provider_type, module, config, supported_domains}, _from, state) do
    Logger.info("Registering provider: #{provider_type} for domains: #{inspect(supported_domains)}")
    ...
    updated_domain_mappings = Enum.reduce(supported_domains, state.domain_mappings, fn domain, acc ->
