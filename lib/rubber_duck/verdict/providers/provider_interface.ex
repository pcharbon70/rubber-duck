defmodule RubberDuck.Verdict.Providers.ProviderInterface do
  ...
  """
  def calculate_cost_estimate(token_count, cost_per_1k_tokens)
  ...
  defp extract_confidence_from_text(lines) do
    ...
    case confidence_line do
      ...
      line ->
        parse_confidence_from_line(line)
    end
  end
  ...
  defp parse_score_from_line(line) do
  ...
  defp parse_confidence_from_line(line) do
    case Regex.run(~r/(\d+\.?\d*)/, line) do
      [_, conf_str] ->
