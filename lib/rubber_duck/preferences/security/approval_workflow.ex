defmodule RubberDuck.Preferences.Security.ApprovalWorkflow do
  ...
  """
  @spec approve_request(approval_request_id :: String.t(), approver_id :: String.t(), notes :: String.t()) :: 
    {:ok, ApprovalRequest.t()} | {:error, term()}
  ...
  """
  @spec reject_request(approval_request_id :: String.t(), approver_id :: String.t(), reason :: String.t()) :: 
    {:ok, ApprovalRequest.t()} | {:error, term()}
  ...
  defp has_approval_role?(approver, request) do
    case get_applicable_policies(request.preference_key, %{resource_type: request.target_resource_type}) do
      {:ok, policies} ->
