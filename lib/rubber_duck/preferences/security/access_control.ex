defmodule RubberDuck.Preferences.Security.AccessControl do
  ...
  def has_role?(%{role: user_role}, required_role) when is_atom(required_role) do
    user_role == required_role or higher_role?(user_role, required_role)
  end
  ...
  defp has_required_permissions?(actor, required_permissions)
  ...
  defp higher_role?(user_role, required_role) do
  ...
  defp get_role_permissions(:user),
    do: [
      "read_preferences",
  ...
  defp get_role_permissions(:project_admin),
    do: [
      "read_preferences",
      "write_own_preferences",
      "read_own_preferences",
      "write_project_preferences",
      "read_project_preferences",
      "manage_project_overrides"
    ]
  ...
  defp get_role_permissions(:security_admin),
    do: [
      "read_preferences",
      "write_preferences",
      "read_all_preferences",
