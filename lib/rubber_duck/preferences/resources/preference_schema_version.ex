defmodule RubberDuck.Preferences.Resources.PreferenceSchemaVersion do
  ...
  actions do
    ...
    create :create do
      ...
      accept [
        :version, :version_name, :description, :migration_required, :breaking_changes,
        :compatibility_matrix, :migration_scripts, :rollback_scripts, :data_transformations,
        :validation_rules, :minimum_app_version, :metadata
      ]
    ...
    update :update do
      ...
      accept [
        :version_name, :description, :compatibility_matrix, :deprecation_notice,
        :metadata
      ]
    end
  ...
  calculations do
    ...
    calculate :version_number, :integer, expr(0)  # Would parse semantic version
