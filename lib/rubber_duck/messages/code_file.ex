defmodule RubberDuck.Messages.CodeFile do
  ...
  defimpl Message, for: FileCreated do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.created", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: FileModified do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.modified", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: FileDeleted do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.deleted", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: AnalyzeFile do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.analyze", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: AnalysisComplete do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.analysis_complete", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: DependenciesAffected do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.dependencies_affected", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: QualityAssessed do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.quality_assessed", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: OptimizationsDetected do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.optimizations_detected", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: SecurityIssueFound do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.security_issue_found", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: RefactoringRequired do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.refactoring_required", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: DocumentationUpdated do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.documentation_updated", data: Map.from_struct(msg), metadata: %{}}
  ...
  defimpl Message, for: FileInitialized do
    ...
    def to_jido_signal(msg),
      do: %{type: "code_file.initialized", data: Map.from_struct(msg), metadata: %{}}
