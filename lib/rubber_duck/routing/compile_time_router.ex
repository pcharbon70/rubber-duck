defmodule RubberDuck.Routing.CompileTimeRouter do
  ...
  defmacro __before_compile__(env) do
    ...
    dispatch_clauses = for {message_module, handler, function} <- routes do
      quote do
    ...
    dispatch_fast_clauses = for {message_module, handler, function} <- routes do
      quote do
    ...
    get_handler_clauses = for {message_module, handler, function} <- routes do
      quote do
