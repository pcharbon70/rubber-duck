defmodule RubberDuck.Skills.LearningSkill do
  ...
  def track_experience(
        %{experience: experience, outcome: outcome, context: context} = _params,
        state
      ) do
    experience_data = %{
    ...
    # Keep last 1000
    updated_experiences = [experience_data | experiences] |> Enum.take(1000)
