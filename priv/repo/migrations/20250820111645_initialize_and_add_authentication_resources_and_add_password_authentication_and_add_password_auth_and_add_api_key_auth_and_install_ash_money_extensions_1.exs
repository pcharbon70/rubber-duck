defmodule RubberDuck.Repo.Migrations.InitializeAndAddAuthenticationResourcesAndAddPasswordAuthenticationAndAddPasswordAuthAndAddApiKeyAuthAndInstallAshMoneyExtensions1 do
  @moduledoc """
