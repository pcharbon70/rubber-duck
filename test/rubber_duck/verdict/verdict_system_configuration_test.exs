  ...
  describe "configuration validation" do
    ...
    test "validate_configuration/1 rejects invalid budget" do
      config = %{
        ...
        default_screening_model: "gpt-4o-mini",
        default_detailed_model: "gpt-4o",
        global_daily_budget: -50.00  # Invalid
      }
      
      assert {:error, "Invalid budget value"} = VerdictSystemConfiguration.validate_configuration(config)
    end
    ...
    test "validate_configuration/1 rejects invalid thresholds" do
      config = %{
        ...
        escalation_threshold: 0.7  # Higher than quality threshold
      }
