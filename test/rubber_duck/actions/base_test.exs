defmodule RubberDuck.Action.BaseTest do
  ...
  describe "telemetry" do
    ...
    test "emits telemetry events for delegation" do
      ...
      assert_receive {:telemetry_event, [:rubber_duck, :action, :delegation, :start],
                      %{system_time: _}, %{module: TestValidator, function: :validate}}

      assert_receive {:telemetry_event, [:rubber_duck, :action, :delegation, :stop],
    ...
    test "emits telemetry events for pipeline steps" do
      ...
      assert_receive {:telemetry_event, [:rubber_duck, :action, :pipeline, :step, :start],
                      %{system_time: _}, %{step: :test_step}}

      assert_receive {:telemetry_event, [:rubber_duck, :action, :pipeline, :step, :stop],
                      %{duration: _, system_time: _}, %{step: :test_step, success: true}}
    end
  end
end
