defmodule RubberDuck.Health.CircuitBreakerTest do
  ...
  describe "check_with_breaker/3" do
    ...
    test "records timing information" do
      result = CircuitBreaker.check_with_breaker(:memory, fn ->
        Process.sleep(10)
    ...
    test "handles check failures gracefully" do
      result = CircuitBreaker.check_with_breaker(:external_service, fn ->
  ...
  describe "circuit management" do
    ...
    test "reset clears circuit and cache" do
      ...
      # Should work again
      result = CircuitBreaker.check_with_breaker(:repo_pool, fn ->
    ...
    test "reset_all clears all circuits" do
      ...
      # All should work
      db_result = CircuitBreaker.check_with_breaker(:database, fn ->
        %{status: :healthy, message: "DB OK"}
      end)
      
      pool_result = CircuitBreaker.check_with_breaker(:repo_pool, fn ->
  ...
  describe "caching behavior" do
    test "caches successful results" do
      ...
      result = CircuitBreaker.check_with_breaker(:atoms, fn ->
